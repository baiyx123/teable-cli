...
class TeableClient:
    ...
    def _request(self, method: str, endpoint: str, data: Optional[Dict] = None, 
        ...
        try:
            ...
            try:
                ...
                logger.info(f"响应数据: {json.dumps(result, ensure_ascii=False, indent=2)[:500]}...")
                return result
    ...
    def get_records(self, table_id: str, page: int = 1, page_size: int = 100, **kwargs) -> Dict[str, Any]:
        ...
        Args:
            ...
            page: 页码，从1开始
            page_size: 每页记录数
            **kwargs: 其他查询参数，如filter, orderBy, take, skip等
        ...
        # 添加其他查询参数
        if kwargs:
            # 如果提供了take和skip，使用提供的值
            if 'take' in kwargs:
                params['take'] = kwargs.pop('take')
            if 'skip' in kwargs:
    ...
    def create_record(self, table_id: str, fields_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        创建单条记录（兼容方法）
        ...
        Returns:
            创建的记录信息
        """
        return self.insert_records(table_id, [{"fields": fields_data}])
